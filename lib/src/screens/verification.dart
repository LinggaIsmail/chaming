...
import 'package:chaming/src/utils/app_countdown.dart';
...
class _OtpVerificationScreenState extends State<OtpVerificationScreenState>
  ...
  void startTimer() {
    var sub = new AppCountDown(new Duration(minutes: 5)).stream.listen(null);
