...
class AppCountDown {
  ...
  /// once you instantiate the AppCountDown you need to register to receive information
  AppCountDown(Duration duration, {Duration refresh: const Duration(milliseconds: 10), int everyTick: 1}) {
    _refresh = refresh;
